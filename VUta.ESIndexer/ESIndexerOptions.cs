...
public class ESIndexerOptions
{
    ...
    [Required] public string Replication { get; set; } = null!;

    [Required] public string Publication { get; set; } = null!;

    [Required] public string Elasticsearch { get; set; } = "http://localhost:9200";
